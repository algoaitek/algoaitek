...
<h2>Introduction</h2>
<p><strong>What is this policy about?</strong>
 This document explains how this website collects, uses, and protects your personal data to achieve the purposes outlined in this document.</p>
...
<p>In cases where this website specifically states that some personal data is not mandatory, you are free not to communicate this data without consequences to the availability or the functioning of the service. </p>
...
We take appropriate security measures to prevent unauthorized access, disclosure, modification, or unauthorized destruction of the data. The data processing is carried out using computers and/or IT enabled tools, following organizational procedures and modes strictly related to the purposes indicated. </p>
<p>In addition to ourselves, in some cases, the data may be accessible to certain types of persons in charge, involved with the operation of this website (e.g. administration, sales team, marketing team, legal team).</p>
<p>The data may also be accessible to external parties appointed, if necessary, as data processors by us. </p>
<p>The updated list of these parties may be requested from us at any time by contacting us at the contact details provided in this document.</p>
...
<p>When we collect your personal information, we keep it for as long as required for the purposes we collected for. Sometimes, we might need to keep your personal information longer due to a legal obligation or based on your consent. </p>
<p>Here’s what that means in more detail. We will keep your personal information based on the purposes and reasons set out below: </p>
<ul>
...
<li><strong>for our legitimate interests:</strong> If we&#39;re using your personal information for purposes that are necessary and relevant to our business operations, we&#39;ll keep it as long as we need it for those purposes. You can learn more about these purposes within the relevant sections of this document or by contacting us. </li>
<li><strong>with your consent:</strong> We may be allowed to retain personal data for a longer period whenever you have given consent to such processing, unless you withdraw your consent. </li>
...
<h2><strong><strong><strong><em>**</em></strong></strong></strong>Information about this document<strong><strong><strong><em>**</em></strong></strong></strong></h2>
<p>This document was generated with the use of the <a href="https://www.iubenda.com/en/help/36387-privacy-policy-template">privacy policy template</a>.</p>
...
<ul>
<li><strong>Withdraw your consent at any time.</strong> You have the right to withdraw consent where they have previously given your consent to the processing of your personal data.</li>
<li><strong>Object to processing of your data.</strong> You have the right to object to the processing of your data if the processing is carried out on a legal basis other than consent.<ul>
<li>If your personal data is processed for public interest, by an official authority, or for our legitimate business interests, you can object by providing a reason related to your particular situation.</li>
<li>However, if your personal data is being processed for direct marketing purposes, you can object at any time, free of charge, and without any reason. If you do, we will stop using your personal data for marketing. To find out if we are using your data for direct marketing, please refer to the relevant sections of this document.</li>
</ul>
</li>
...
<li><strong>Learn about the reason for data transfers.</strong> You are also entitled to learn about the legal basis for data transfers abroad, including to any international organization governed by public international law or set up by two or more countries, such as the UN. </li>
<li><strong>Know about security measures.</strong> You have the right to know about the security measures we take to safeguard your data.</li>
</ul>
<h3>How to exercise these rights</h3>
<p> Any requests to exercise your rights can be directed to us. Our full contact details can be found at the start of this document.</p>
<p>Such requests are free of charge and will be answered by us as early as possible, providing you with the information required by law. </p>
<p>Any rectification or erasure of personal data or restriction of processing will be communicated by us to each recipient, if any, to whom the personal data has been disclosed unless this proves impossible or involves disproportionate effort. At your request, we will inform you about those recipients.</p>
<h2>Further information if you reside in Switzerland</h2>
<p> This section applies to you if you reside in Switzerland, and supersedes any other possibly divergent or conflicting information contained in the privacy policy.</p>
...
<p> You may exercise certain rights regarding your data within the limits of law, including the following:</p>
<ul>
<li>right of access to personal data;</li>
<li>right to object to the processing of your personal data (which also allows you to demand that processing of personal data be restricted, personal data be deleted or destroyed, specific disclosures of personal data to third parties be prohibited);</li>
<li>right to receive your personal data and have it transferred to another controller (data portability);</li>
<li>right to ask for incorrect personal data to be corrected.</li>
</ul>
<h3>How to exercise these rights</h3>
<p> Any requests to exercise your rights can be directed to us through the contact details provided at the start of this document. Such requests are free of charge and will be answered by us as early as possible, providing you with the information required by law.</p>
<h2>Further information if you reside in Brazil</h2>
<p> This section of the document integrates with and supplements the information contained in the rest of the privacy policy and is provided by the entity running this website and, if the case may be, its parent, subsidiaries and affiliates (for the purposes of this section referred to collectively as “we”, “us”, “our”).</p>
<p>This section applies to all Users in Brazil (Users are referred to below, simply as “you”, “your”, “yours”), according to the &quot;Lei Geral de Proteção de Dados&quot; (the &quot;LGPD&quot;), and for such Users, it supersedes any other possibly divergent or conflicting information contained in the privacy policy. This part of the document uses the term “personal information” as it is defined in the LGPD.</p>
...
<p>To find out more about the legal bases, you can contact us at any time using the contact details provided at the start of this document.</p>
...
<p> You can file your express request to exercise your rights free from any charge, at any time, by using the contact details provided at the start of this document, or via your legal representative.</p>
<h3>How and when we will respond to your request</h3>
<p><strong>Prompt responses</strong>
...
<p><strong>Access or processing confirmation requests</strong>
...
<p><strong>Rectification, deletion, anonymization or personal information blocking requests</strong>
...
<h4>Applicability</h4>
<p> This section applies to all users (users are referred to below, simply as “you”, “your”, “yours”), who are consumers residing in the state of California, United States of America, according to the &quot;California Consumer Privacy Act of 2018&quot; (the &quot;CCPA&quot;), as updated by the &quot;California Privacy Rights Act&quot; (the &quot;CPRA&quot;) and subsequent regulations. For such consumers, this section supersedes any other possibly divergent or conflicting information contained in the privacy policy.</p>
<h4>Definition</h4>
<p> This part of the document uses the term “personal information“ as defined in the California Consumer Privacy Act(CCPA/CPRA).</p>
<h3>Categories of personal information that we collect</h3>
<ul>
<li>We have collected the following categories of personal information about you: <ul>
...
<p><strong>Business Purposes</strong>
We may use your personal information to allow the operational functioning of this website and features thereof. In such cases, your personal information will be processed in a fashion necessary and proportionate to the business purpose for which it was collected, and strictly within the limits of compatible operational purposes.</p>
<p><strong>Commercial Purposes</strong>
We may also use your personal information for other reasons such as for commercial purposes, as well as for complying with the law and defending our rights before the competent authorities where our rights and interests are threatened, or we suffer an actual damage.</p>
<p><strong>No unexpected or incompatible purposes</strong>
We won’t process your information for unexpected purposes, or for purposes incompatible with the purposes originally disclosed, without your consent.</p>
...
<p><strong>Direct Collection:</strong> For example, you directly provide your personal information when you submit requests via any forms on this website. </p>
<p><strong>Indirect Collection</strong>: You also provide personal information indirectly when you navigate this website, as personal information about you is automatically observed and collected.</p>
<p><strong>Third Parties</strong>: Finally, we may collect your personal information from third parties that work with us in connection with the service or with the functioning of this Application and features thereof.</p>
<h3>How we use the information we collect</h3>
<p><strong>Disclosing of your personal information with third parties for a business purpose</strong>
...
We disclose your personal information with the third parties listed in detail in the section titled “Detailed information on the processing of personal data” within this document. These third parties are grouped and categorized in accordance with the different purposes of processing.</p>
<p><strong>Sale or sharing of your personal information</strong>
...
<p>We use any personal information collected from you in connection with the submission of your opt-out request solely for the purposes of complying with the opt-out request. Once you have opted out, we are required to wait at least 12 months before asking whether you have changed your mind.</p>
...
<p><strong>The right to request the deletion of your personal information</strong>
...
<p><strong>The right to correct inaccurate personal information</strong>
You have the right to request that we correct any inaccurate personal information we maintain about you, considering the nature of the personal information and the purposes of the processing of the personal information.</p>
<p><strong>The right to opt out of sale or sharing of personal information and to limit the use of your sensitive personal information</strong>
You have the right to opt out of the sale or sharing of your personal information. You also have the right to request that we limit our use or disclosure of your sensitive personal information.</p>
<p><strong>The right of no retaliation following opt-out or exercise of other rights (the right to non-discrimination)</strong>
...
To the extent permitted by the law, we may offer you promotions, discounts, and other deals in exchange for collecting, keeping, or selling your personal information, provided that the financial incentive offered is reasonably related to the value of your personal information.</p>
<p><strong>How to exercise your rights</strong></p>
<ul>
<li>To exercise the rights described above, you need to submit your verifiable request to us by contacting us via the details provided at the start of this document.</li>
<li>For us to respond to your request, it’s necessary that we know who you are. Therefore, you can only exercise the above rights by making a verifiable request which must:<ul>
<li>provide sufficient information that allows us to reasonably verify you are the person about whom we collected personal information or an authorized representative;</li>
<li>describe your request with sufficient detail that allows us to properly understand, evaluate, and respond to it.</li>
</ul>
</li>
<li>We will not respond to any request if we are unable to verify your identity and therefore confirm the personal information in our possession actually relates to you.</li>
<li>Making a verifiable consumer request does not require you to create an account with us. We will use any personal information collected from you in connection with the verification of your request solely for the purposes of verification and shall not further disclose the personal information, retain it longer than necessary for purposes of verification, or use it for unrelated purposes.</li>
<li>If you cannot personally submit a verifiable request, you can authorize a person registered with the California Secretary of State to act on your behalf.</li>
<li>If you are an adult, you can make a verifiable request on behalf of a child under your parental authority.</li>
...
<ul>
<li>We will confirm receipt of your verifiable request within 10 days and provide information about how we will process your request.</li>
<li>We will respond to your request within 45 days of its receipt. Should we need more time, we will explain to you the reasons why, and how much more time we need. In this regard, please note that we may take up to 90 days to fulfill your request.</li>
<li>Our disclosure(s) will cover the preceding 12-month period. Only with regard to personal information collected on or after January 1, 2022, you have the right to request that we disclose information beyond the 12-month period, and we will provide them to you unless doing so proves impossible or would involve a disproportionate effort.</li>
<li>Should we deny your request, we will explain you the reasons behind our denial.</li>
<li>We do not charge a fee to process or respond to your verifiable request unless such request is manifestly unfounded or excessive. In such cases, we may charge a reasonable fee, or refuse to act on the request. In either case, we will communicate our choices and explain the reasons behind it.</li>
</ul>
...
<p>This section applies to you if you reside in the Commonwealth of Virginia, according to the “Virginia Consumer data Protection Act&quot; (the &quot;VCDPA&quot;), and, it supersedes any other possibly divergent or conflicting information contained in the privacy policy. This part of the document uses the term “personal data” as defined in the VCDPA.</p>
<h3>Categories of personal data processed</h3>
<p> You can read about these activities in detail in the section titled “Detailed information on the processing of personal data” <em>**</em> within this document.</p>
...
<p> To find out why we process your personal data, you can read the sections titled “Detailed information on the processing of personal data” and “The purposes of processing” within this document.
We won’t process your information for unexpected purposes, or for purposes incompatible with the purposes originally disclosed, without your consent. You can freely give, deny, or withdraw such consent at any time using the contact details provided at the start of this document.</p>
<h3>How we use the data we collect: sharing of your personal data with third parties</h3>
<p> We share your personal data with the third parties listed in detail in the section titled “Detailed information on the processing of personal data” within this document. These third parties are grouped and categorized in accordance with the different purposes of processing. For our purposes, the word &quot;third party&quot; means &quot;a natural or legal person, public authority, agency, or body other than the consumer, controller, processor, or an affiliate of the processor or the controller&quot; as defined by the VCDPA.</p>
<h3>Sale of your personal data</h3>
<p> For our purposes, the word “sale” means any “exchange of personal data for monetary consideration by us to a third party” as defined by the VCDPA. Please note that according to the VCDPA, the disclosure of personal data to a processor that processes personal data on behalf of a controller does not constitute a sale. In addition, other specific exceptions set forth in the VCDPA may apply, such as, but not limited to, the disclosure of personal data to a third party for the provision of a product or service requested by you. As specified in the “Detailed information on the processing of personal data” section of this document, our use of your personal information may be considered a sale under VCDPA.</p>
<h3>Your right to opt out of the sale of your personal data and how you can exercise it</h3>
<p> You have the right to opt out of the sale of your personal data. This means that whenever you request us to stop selling your data, we will abide by your request. To fully exercise your right to opt out you can contact us at any time using the contact details provided at the start of this document.
We use any personal data collected from you in connection with the submission of your opt-out request solely for the purpose of complying with the request.</p>
<h3>Processing of your personal data for targeted advertising</h3>
<p> We do not process your personal data for targeted advertising. If we decide to do so, we will inform you beforehand and will grant your right to opt out of the processing of your personal data for targeted advertising.</p>
<h3>Your privacy rights under the Virginia Consumer data Protection Act and how to exercise them</h3>
<p> You may exercise certain rights regarding your data processed by us. You have the right to do the following:</p>
<ul>
<li><strong>access personal data: the right to know.</strong> You have the right to request that we confirm whether we are processing your personal data. You also have the right to access such personal data.</li>
<li><strong>correct inaccurate personal data.</strong> You have the right to request that we correct any inaccurate personal data we maintain about you, considering the nature of the personal data and the purposes of the processing of the personal data.</li>
<li><strong>request the deletion of your personal data.</strong> You have the right to request that we delete any of your personal data.</li>
<li><strong>obtain a copy of your personal data.</strong> We will provide your personal data in a portable and usable format that allows you to transfer data easily to another entity — if this is technically feasible.</li>
<li><strong>opt out of the processing of your personal data for the purposes of targeted advertising</strong>, the <strong>sale of personal data</strong>, or <strong>profiling</strong> in furtherance of decisions that produce legal or similarly significant effects concerning you.</li>
<li><strong>non-discrimination.</strong> We will not discriminate against you for exercising your rights under the VCDPA. This means that we will not, among other things, deny goods or services, charge you a different price, or provide a different level or quality of goods or services just because you exercised your consumer privacy rights. However, if you refuse to provide your personal data to us or ask us to delete or stop selling your personal data, and that personal data or sale is necessary for us to provide you with goods or services, we may not be able to complete that transaction. To the extent permitted by the law, we may offer a different price, rate, level, quality, or selection of goods or services to you, including offering goods or services for no fee, if you have exercised your right to opt out, or our offer is related to your voluntary participation in a bona fide loyalty, rewards, premium features, discounts, or club card program. </li>
</ul>
<h3>How to exercise your rights</h3>
<ul>
<li>To exercise the rights described above, you need to submit your request to us by contacting us via the contact details provided at the start of this document.</li>
<li>For us to respond to your request, we need to know who you are.</li>
<li>We will not respond to any request if we are unable to verify your identity using commercially reasonable efforts and therefore confirm that the personal data in our possession relates to you. In such cases, we may request that you provide additional information which is reasonably necessary to authenticate you and your request.</li>
<li>Making a consumer request does not require you to create an account with us. However, we may require you to use your existing account. We will use any personal data collected from you in connection with your request solely for the purposes of authentication, without further disclosing the personal data, retaining it longer than necessary for purposes of authentication, or using it for unrelated purposes.</li>
...
<ul>
<li>We will respond to your request without undue delay, but in all cases and at the latest within 45 days of its receipt. Should we need more time, we will explain to you the reasons why, and how much more time we need. In this regard, please note that we may take up to 90 days to fulfill your request.</li>
<li>Should we deny your request, we will explain to you the reasons behind our denial without undue delay, but in all cases and at the latest within 45 days of receipt of the request. It is your right to appeal such decision by submitting a request to us via the details provided in this document. Within 60 days of receipt of the appeal, we will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions. If the appeal is denied you may contact the Attorney General to submit a complaint.</li>
<li>We do not charge a fee to respond to your request, for up to two requests per year. If your request is manifestly unfounded, excessive or repetitive, we may charge a reasonable fee or refuse to act on the request. In either case, we will communicate our choices and explain the reasons behind them.</li>
</ul>
<h2>Further information if you reside in Colorado</h2>
<p> This section of the document integrates with and supplements the information contained in the rest of the privacy policy and is provided by the controller running this website and, if the case may be, its parent, subsidiaries and affiliates (for the purposes of this section referred to collectively as “we”, “us”, “our”).</p>
<p>This section applies to you if you reside in the State of Colorado, according to the “Colorado Privacy Act&quot; (the &quot;CPA&quot;), and, supersedes any other possibly divergent or conflicting information contained in the privacy policy.
This part of the document uses the term “personal data” as defined in the CPA.</p>
<h3>Categories of personal data processed</h3>
<p> In this section, we summarize the categories of personal data that we&#39;ve processed and the purposes thereof. You can read about these activities in detail in the section titled “Detailed information on the processing of personal data” within this document.</p>
...
We won’t process your information for unexpected purposes, or for purposes incompatible with the purposes originally disclosed, without your consent. You can freely give, deny, or withdraw such consent at any time using the contact details provided at the start of this document.</p>
<h3>How we use the data we collect: sharing of your personal data with third parties</h3>
<p> We share your personal data with the third parties listed in detail in the section titled “Detailed information on the processing of personal data” within this document. These third parties are grouped and categorized in accordance with the different purposes of processing.
For our purposes, the word &quot;third party&quot; means &quot;a person, public authority, agency, or body other than a consumer, controller, processor, or affiliate of the processor or the controller.&quot; as defined by the CPA.</p>
<h3>Sale of your personal data</h3>
<p> As specified in the “Detailed information on the processing of personal data” section of this document, our use of your personal data may be considered a sale under the CPA.
...
<h3>Your right to opt out of the sale of your personal data and how you can exercise it</h3>
<p> You have the right to opt out of the sale of your personal data. This means that whenever you request us to stop selling your data, we will abide by your request.
...
We use any personal data collected from you in connection with the submission of your opt-out request solely for the purpose of complying with the request.</p>
<h3>Processing of your personal data for targeted advertising</h3>
<p> We do not process your personal data for targeted advertising. If we decide to do so, we will inform you beforehand and will grant your right to opt out of the processing of your personal data for targeted advertising.
...
<p> This section of the document integrates with and supplements the information contained in the rest of the privacy policy and is provided by the controller running this website and, if the case may be, its parent, subsidiaries and affiliates (for the purposes of this section referred to collectively as “we”, “us”, “our”).</p>
<p>This section applies to you if you reside in the State of Connecticut, according to “An Act Concerning personal data Privacy and Online Monitoring &quot; (also known as &quot;The Connecticut data Privacy Act&quot; or the “CTDPA&quot;), and, for such consumers, it supersedes any other possibly divergent or conflicting information contained in the privacy policy.
This part of the document uses the term “personal data” as defined in the CTDPA.</p>
<h3>Categories of personal data processed</h3>
<p> You can read about these activities in detail in the section titled “Detailed information on the processing of personal data” within this document.</p>
<h3>Categories of personal data we collect</h3>
<ul>
<li>We have collected the following categories of personal data: identifiers and internet information</li>
<li>We do not collect sensitive data.</li>
...
<h3>How we use the data we collect: sharing of your personal data with third parties</h3>
<p> We share your personal data with the third parties listed in detail in the section titled “Detailed information on the processing of personal data” within this document. These third parties are grouped and categorized in accordance with the different purposes of processing.
For our purposes, the word &quot;third party&quot; means &quot;a person, public authority, agency, or body other than a consumer, controller, processor, or affiliate of the processor or the controller.&quot; as defined by the CTDPA.</p>
<h3>Sale of your personal data</h3>
<p> As specified in the “Detailed information on the processing of personal data” section of this document, our use of your personal data may be considered a sale under the CTDPA.
...
<p> You may exercise certain rights regarding your data processed by us. In particular, you have the right to do the following:
...
opt out of the processing of your personal data for the purposes of targeted advertising, the sale of personal data, or profiling in furtherance of decisions that produce legal or similarly significant effects concerning you.</p>
<p>In any case, we will not increase the cost of, or decrease the availability of, a product or service, based solely on the exercise of any of your rights and unrelated to the feasibility or the value of a service. However, to the extent permitted by the law, we may offer a different price, rate, level, quality, or selection of goods or services to you, including offering goods or services for no fee, if our offer is related to your voluntary participation in a bona fide loyalty, rewards, premium features, discounts, or club card program.</p>
<h3>How to exercise your rights</h3>
<ul>
<li>To exercise the rights described above, you need to submit your request to us by contacting us via the contact details provided at the start of this document.</li>
...
<p> This section of the document integrates with and supplements the information contained in the rest of the privacy policy and is provided by the controller running this website and, if the case may be, its parent, subsidiaries and affiliates (for the purposes of this section referred to collectively as “we”, “us”, “our”).
...
This part of the document uses the term “personal data” as defined in the UCPA.</p>
<h3>Categories of personal data processed</h3>
<p> You can read about these activities in detail in the section titled “Detailed information on the processing of personal data” within this document.</p>
<h3>Categories of personal data we collect</h3>
<ul>
...
<h3>How we use the data we collect: sharing of your personal data with third parties</h3>
<p> We share your personal data with the third parties listed in detail in the section titled “Detailed information on the processing of personal data” within this document. These third parties are grouped and categorized in accordance with the different purposes of processing.</p>
...
<h3>Sale of your personal data</h3>
<p> As specified in the “Detailed information on the processing of personal data” section of this document, our use of your personal data may be considered a sale under the UCPA.
...
response to the consumer&#39;s request for information, product, a service or feedback; or processing personal data solely to measure or report advertising performance, reach or frequency.”</p>
<h3>Your privacy rights under the Utah Consumer Privacy Act and how to exercise them</h3>
<p> You may exercise certain rights regarding your data processed by us. You have the right to do the following:
access personal data. You have the right to request that we confirm whether we are processing your personal data. You also have the right to access such personal data.
request the deletion of your personal data. You have the right to request that we delete any of your personal data.
...
opt out of the processing of your personal data for the purposes of targeted advertising or the sale of personal data.</p>
<p>In any case, we will not increase the cost of, or decrease the availability of, a product or service, based solely on the exercise of any of your rights and unrelated to the feasibility or the value of a service. However, to the extent permitted by the law, we may offer a different price, rate, level, quality, or selection of goods or services to you, including offering goods or services for no fee, if our offer is related to your voluntary participation in a bona fide loyalty, rewards, premium features, discounts, or club card program.</p>
<h3>How to exercise your rights</h3>
<ul>
<li>To exercise the rights described above, you need to submit your request to us by contacting us via the contact details provided at the start of this document.</li>
<li>For us to respond to your request, we need to know who you are and which right you wish to exercise.</li>
<li>We will not respond to any request if we are unable to verify your identity using commercially reasonable efforts and therefore confirm that the personal data in our possession actually relate to you. In such cases, we may request that you provide additional information which is reasonably necessary to authenticate you and your request. We may retain your email address to respond to your request.</li>
<li>If you are an adult, you can make a request on behalf of a child under your parental authority.</li>
</ul>
<h3>How and when we are expected to handle your request</h3>
<ul>
<li>We will respond to your request without undue delay, but in all cases and at the latest within 45 days of its receipt. Should we need more time, we will explain to you the reasons why, and how much more time we need. In this regard, please note that we may take up to 90 days to fulfill your request.</li>
<li>Should we deny your request, we will explain to you the reasons behind our denial without undue delay, but in all cases and at the latest within 45 days of receipt of the request.</li>
<li>We do not charge a fee to respond to your request, for up to one request per year.</li>
</ul>
<h2><strong><strong>**</strong></strong>Information about this document<strong><strong>**</strong></strong></h2>
<p>This document was generated with the use of the <a href="https://www.iubenda.com/en/help/36387-privacy-policy-template">privacy policy template</a>.</p>
...
<p><strong>Additional information about your personal data</strong>
In addition to the information contained in this privacy policy, this website may provide you with additional and contextual information concerning particular services or the collection and processing of personal data upon request.</p>
...
<p><strong>Information not contained in this policy</strong>
More details concerning the collection or processing of personal data may be requested from us at any time. Please see the contact information at the start of this document.</p>
